# 1        Introduction ✔️
  ...
  - [x] 1.5 Data representation

       - [x] 1.5.1 Bits

       - [x] 1.5.2 Two Byte Integer

       - [x] 1.5.3 Four Byte Integer

       - [x] 1.5.4 UTF-8 Encoded String

       - [x] 1.5.5 Variable Byte Integer
  ...
  - [x] 1.7 Editing convention

  - [x] 1.8 Change history

       - [x] 1.8.1 MQTT v3.1.1

       - [x] 1.8.2 MQTT v5.0

# 2        MQTT Control Packet format ✔️
